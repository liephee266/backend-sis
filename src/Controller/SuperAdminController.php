...
class SuperAdminController extends AbstractController
{
    ...
    public function create(Request $request): Response
    {
        ...
        if (!empty($errors['entity'])) {
            ...
            return $this->json(['data' => $errors['entity'],'code' => 200, 'message' => "SuperAdmin crée avec succès"], Response::HTTP_OK);
        }
    ...
    public function update(Request $request,  $id): Response
    {
        ...
        if (!empty($errors['entity'])) {
            ...
            return $this->json(['data' => $errors['entity'],'code' => 200, 'message' => "SuperAdmin modifié avec succès"], Response::HTTP_OK);
        }
