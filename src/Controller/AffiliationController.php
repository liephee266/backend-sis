    ...
    public function create(Request $request): Response
    {
        try {
            ...
            if (!empty($errors['entity'])) {
                ...
                return new JsonResponse(['data' => json_decode($this->serializer->serialize($errors['entity'], 'json', ['groups' => 'affiliation:read']), true), "message" => "Affiliation crée avec succès", "code" => 200], Response::HTTP_OK);
            }
    ...
    public function update(Request $request,  $id): Response
    {
        try {
            ...
            if (!empty($errors['entity'])) {
                ...
                return $this->json(['data' => $errors['entity'],'code' => 200, 'message' => "Affiliation modifié avec succès"], Response::HTTP_OK);
                return new JsonResponse(json_decode($this->serializer->serialize($errors['entity'], 'json', ['groups' => 'affiliation:read']), true), Response::HTTP_CREATED);
