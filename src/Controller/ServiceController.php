    ...
    public function create(Request $request): Response
    {
        try {
            ...
            if (!empty($errors['entity'])) {
                ...
                return $this->json(['data' => $errors['entity'],'code' => 200, 'message' => "Service crée avec succès"], Response::HTTP_OK);
            }
    ...
    public function update(Request $request,  $id): Response
    {
        try {
            ...
            if (!empty($errors['entity'])) {
                ...
                return $this->json(['data' => $errors['entity'],'code' => 200, 'message' => "Service modifié avec succès"], Response::HTTP_OK);
            }
