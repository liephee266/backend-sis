...
#[ApiEntity(\App\Entity\HospitalAdmin::class)]
class HospitalAdminController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        try {
            ...
            return $this->json(['code' => 500, 'message' => "Erreur lors de la recherche des HospitalAdmins" . $th->getMessage()], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    ...
    public function show(HospitalAdmin $hospitaladmin): Response
    {
        try {
            ...
            return $this->json(['code' => 500, 'message' => "Erreur lors de la recherche de l'HospitalAdmin" . $th->getMessage()], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public function create(Request $request): Response
    {
        try {
            ...
            return $this->json(['code' => 500, 'message' => "Erreur lors de la création de l'admin hopital" . $th->getMessage()], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    ...
    public function update(Request $request,  $id): Response
    {
        try {
            ...
            return $this->json(['code' => 500, 'message' => "Erreur lors de la modification de l'HospitalAdmin" . $th->getMessage()], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    ...
    public function delete(HospitalAdmin $hospitaladmin, EntityManagerInterface $entityManager): Response
    {
        try {
            ...
            return $this->json(['code' => 500, 'message' => "Erreur lors de la suppression de l'HospitalAdmin" . $th->getMessage()], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    }
}
