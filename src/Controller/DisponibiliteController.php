    ...
    public function create(Request $request): Response
    {
        try {
            ...
            if (!empty($errors['entity'])) {
                ...
                return $this->json(['code' => 200, 'message' => "Disponibilité créée avec succès"], Response::HTTP_OK);
            }
    ...
    public function update(Request $request,  $id): Response
    {
        try {
            ...
            if (!empty($errors['entity'])) {
                ...
                return $this->json(['code' => 200, 'message' => "Disponibilité modifiée avec succès"], Response::HTTP_OK);
            }
