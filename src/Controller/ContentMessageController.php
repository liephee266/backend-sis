...
class ContentMessageController extends AbstractController
{
    ...
    public function create(Request $request): Response
    {
        ...
        if (!empty($errors['entity'])) {
            ...
            return $this->json(['code' => 200, 'message' => "ContentMessage crée avec succès"], Response::HTTP_OK);
        }
    ...
    public function update(Request $request,  $id): Response
    {
        ...
        if (!empty($errors['entity'])) {
            ...
            return $this->json(['code' => 200, 'message' => "ContentMessage modifié avec succès"], Response::HTTP_OK);
        }
